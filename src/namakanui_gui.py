...
class STSRFrame(tk.Frame):
    ...
    def setup(self):
        ...
        self.v_24vdc = grid_label(status_frame, '24V * 0.4', 5)
        self.v_12vdc = grid_label(status_frame, '12V * 0.4', 6)
        self.v_p5vdc = grid_label(status_frame, '+5V * 0.4', 7)
        self.v_n5vdc = grid_label(status_frame, '-5V * 0.4', 8)
...
class BandFrame(tk.Frame):
    def __init__(self, band, master=None):
        ...
        # Cross-check with temp_mon.py
        if self.band == 3:
            self.tnames = ['spare', '110k', 'p0', 'spare', '15k', 'p1']
            self.tokay = [(-2,2), (70,115), (0,30), (-2,2), (5,30), (0,30)]
        elif self.band == 6:
